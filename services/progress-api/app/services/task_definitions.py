...
WEEKLY_TASKS: Dict[int, Dict[str, Any]] = {
    -2: {
        ...
        "weekly": [
            ...
            {"id": "hold_quests", "label": "Minimize side quests until Sunday to stack DMF 10% Renown", "done": False},
        ],
        "daily": [],
    },
    -1: {
        ...
        "weekly": [
            {"id": "no_crests", "label": "Do NOT spend any crests unless instructed", "done": False},
            ...
            {"id": "m0_tour", "label": "Complete M0 World Tour (drops 3/6 Veteran 240) — do NOT upgrade", "done": False},
        ],
        "daily": [],
    },
    0: {
        ...
        "weekly": [
            ...
            {"id": "weekly_events", "label": "Complete weekly events", "done": False},
            {"id": "m0_tour", "label": "Complete M0 World Tour (drops 3/6 Veteran 240) — do NOT upgrade", "done": False},
            {"id": "craft_246", "label": "Craft 2x 246 ilvl pieces (80x Vet Dawncrests each) before reset (if raiding Mar 17)", "done": False},
        ],
        "daily": [],
    },
    1: {
        ...
        "weekly": [
            ...
            {"id": "pvp_quest", "label": "Do PvP quest for guaranteed Hero track neck/ring (do NOT upgrade)", "done": False},
    ...
    7: {
        ...
        "weekly": [
            ...
            {"id": "no_craft", "label": "Do not craft in any slot if you can get >1/6 Mythic from vault", "done": False},
            {"id": "farm_m12", "label": "Farm +12s for vault slots and crests", "done": False},
