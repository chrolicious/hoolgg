...
class UserTrackedCharacter(Base):
    ...
    bnet_id = Column(Integer, nullable=False, index=True)
    ...
    def __repr__(self):
        return f"<UserTrackedCharacter(id={self.id}, character={self.character_name}, guild_id={self.guild_id}, bnet_id={self.bnet_id})>"
